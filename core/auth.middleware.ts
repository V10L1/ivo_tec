...
// FIX: Removed aliasing for express types to avoid conflict with DOM types.
...
export const isDeveloper = (req: express.Request, res: express.Response, next: NextFunction) => {
